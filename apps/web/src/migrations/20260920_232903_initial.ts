...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_users_role" AS ENUM('SUPER_ADMIN', 'ADMIN', 'RECRUITER', 'CONTENT_MANAGER', 'MARKETING', 'VIEWER');
  CREATE TYPE "public"."enum_pages_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum_redirects_type" AS ENUM('301', '410', 'noindex');
